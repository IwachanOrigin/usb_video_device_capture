...
#ifndef VIDEO_CAPTURE_CALLBACK_SHADER_H_
#define VIDEO_CAPTURE_CALLBACK_SHADER_H_
...
class VideoCaptureCBShader : public VideoCaptureCallback
{
  long m_ref;

public:
  explicit VideoCaptureCBShader();
  virtual ~VideoCaptureCBShader();
...
#endif // VIDEO_CAPTURE_CALLBACK_SHADER_H_
